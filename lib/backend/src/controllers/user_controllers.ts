...
import { createToken, verifyToken } from "../utils/token_manager.js";
...
const userSignup = async (req: SignupRequest, res: Response, next: NextFunction): Promise<Response> => {
  try {
    ...
    newUser.chatbots = [chatbotId as any];
    newUser.chats = [chatId as any];
    await newUser.save();
...
// User login
const userLogin = async (req: LoginRequest, res: Response, next: NextFunction): Promise<Response> => {
  try {
...
// Verify user
const verifyUser = async (req: Request, res: Response, next: NextFunction): Promise<Response> => {
  try {
...
// Forgot password
const forgotPassword = async (req: ForgotPasswordRequest, res: Response, next: NextFunction): Promise<Response> => {
  try {
