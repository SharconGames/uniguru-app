...
export const talkWithPdfContent = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const createPdf = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const scanImageText = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const editImageText = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const filePath = req.file.path; // Path of the uploaded image
